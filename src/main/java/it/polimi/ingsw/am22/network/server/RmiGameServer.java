 ...
 *
 * Estende {@link UnicastRemoteObject} per essere direttamente esportabile
 * come oggetto remoto. Ogni chiamata a {@link #submitRequest} crea un
 * {@link RmiClientChannel} sopra il callback del client e delega la
 * gestione al {@link NetworkGameService}.
 */
