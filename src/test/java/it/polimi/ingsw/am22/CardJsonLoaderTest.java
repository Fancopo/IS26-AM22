...
public class CardJsonLoaderTest {
    ...
    void shouldContainAllBuildingEffectTypes() {
        ...
        assertTrue(buildings.stream().anyMatch(b -> b.getEffect() instanceof it.polimi.ingsw.am22.Building.CollectionRewardEffect));
        assertTrue(buildings.stream().anyMatch(b -> b.getEffect() instanceof it.polimi.ingsw.am22.Building.SustenanceDiscountEffect));
        assertTrue(buildings.stream().anyMatch(b -> b.getEffect() instanceof it.polimi.ingsw.am22.Building.ShamanicModifierEffect));
        assertTrue(buildings.stream().anyMatch(b -> b.getEffect() instanceof it.polimi.ingsw.am22.Building.EventYieldBonusEffect));
        assertTrue(buildings.stream().anyMatch(b -> b.getEffect() instanceof it.polimi.ingsw.am22.Building.EndGameScoringEffect));
        assertTrue(buildings.stream().anyMatch(b -> b.getEffect() instanceof it.polimi.ingsw.am22.Building.TurnPhaseModifierEffect));
    }
    @Test
